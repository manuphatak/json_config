# -*- coding: utf-8 -*-
#
# JSON Config documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'jsonconfig', u'JSON Config Documentation', [author], 1)]
...
texinfo_documents = [(master_doc, 'JSONConfig', u'JSON Config Documentation',
                      author, 'JSONConfig', 'One line description of project.',
                      'Miscellaneous'), ]
